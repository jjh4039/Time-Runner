...
public class ZipLine : MonoBehaviour
{
    ...
    IEnumerator MoveZipLine()
    {
        ...
        if (nowStop == false)
        {
            ...
            GameManager.instance.player.rigid.linearVelocity = new Vector2(GameManager.instance.player.rigid.linearVelocity.x, GameManager.instance.player.jumpForce + 0.1f); // 임시 ㅇㅅㅇ
